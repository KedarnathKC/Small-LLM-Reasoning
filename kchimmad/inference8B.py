...
for i in tqdm(range(0, len(data_test["question"]), batch_size), desc="Processing questions"):
    ...
    with torch.no_grad():
        ...
        # output = model.generate(**tokenized_inputs, max_length=2000, num_return_sequences=1, pad_token_id=tokenizer.pad_token_id, do_sample=True, temperature=0.1, top_p=0.7)
...
with open("../outputs/gsm8k/LLaMA8B/generated_outputs_test_new_prompt_greedy.json", "w") as f:
