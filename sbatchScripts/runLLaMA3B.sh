...
hostname
lm_eval --model hf \
    --model_args pretrained=meta-llama/Llama-3.2-3B-Instruct,token=${HF_TOKEN},cache_dir='/scratch/workspace/wenlongzhao_umass_edu-analyze/Bidirectional-Teacher-Student-Communication-for-LLM-Alignment/transformers_cache',dtype='bfloat16' \
