...
import os, sys
from small_llm_reasoning.evaluation.m2scorer import levenshtein
# import levenshtein
from getopt import getopt
from small_llm_reasoning.evaluation.m2scorer.util import paragraphs
from small_llm_reasoning.evaluation.m2scorer.util import smart_open
...
def evaluate(gold_file_path, system_sentences, max_unchanged_words=2, beta=0.5, ignore_whitespace_casing=False, verbose=False, very_verbose=False):
    # load source sentences and gold edits
    source_sentences, gold_edits = load_annotation(gold_file_path)
    p, r, f1, score = levenshtein.batch_multi_pre_rec_f1(system_sentences, source_sentences, gold_edits, max_unchanged_words, beta, ignore_whitespace_casing, verbose, very_verbose)
    return f1, score
