...
python scripts/sft.py \
    ...
    --output_dir ./outputs/exp-6.2.3.2.2.3/checkpoints/ \
    --formatting_func gec \
    --add_special_tokens \
    --sample \
    --sampling_ratio 0.9 \
...
python src/small_llm_reasoning/utils/merge_lora_weights.py \
    ...
    --checkpoints_path "./outputs/exp-6.2.3.2.2.3/checkpoints" \
    --save_path "./outputs/exp-6.2.3.2.2.3/merged_checkpoints" \
