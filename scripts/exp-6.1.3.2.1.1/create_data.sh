...
python scripts/create_data.py \
    ...
    --student_data_path ./outputs/exp-5.2.2.1/feedback-100/teacherlogprobs.json \
    --output_path  ./datasets/neutralization/sft/LLaMA8B/feedback-100/sft_data_with_teacher_gen \
    --input_col input \
    --output_col edits 