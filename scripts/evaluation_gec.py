...
from small_llm_reasoning.evaluation.gec import get_score
...
def generate(model_path, eval_data_path, m2_file_path, reference_col, max_tokens, log_probs, temperature, top_p, top_k, n_samples, n_gpus, output_path):
    ...
    score = get_score(eval_data_path,output_path, m2_file_path, reference_col)
...
def main():
    ...
    parser.add_argument('--m2_file_path', type=str, required=True)
