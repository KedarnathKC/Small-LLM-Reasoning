...
#     --output_path ./outputs/exp-5.2.2.1/feedback/studentlogprobs.json \
#     --answer_col edits \
#     --batch_size 16 \
...
python scripts/hf_logprobs_student.py \
    ...
    --output_path ./outputs/exp-5.2.2.1/feedback-100/studentlogprobs.json \
    --answer_col edits \
    --batch_size 16 \
...
python scripts/hf_logprobs_student.py \
    ...
    --output_path ./outputs/exp-5.2.2.1/feedback-400/studentlogprobs.json \
    --answer_col edits \
    --batch_size 16 \
...
python scripts/hf_logprobs_student.py \
    ...
    --output_path ./outputs/exp-5.2.2.1/feedback-1600/studentlogprobs.json \
    --answer_col edits \
    --batch_size 16 \