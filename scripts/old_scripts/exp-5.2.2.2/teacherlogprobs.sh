...
python scripts/hf_logprobs_teacher.py \
    ...
    --student_logprobs_path ./outputs/exp-5.2.2.2/feedback-100/studentlogprobs.json \
    --output_path ./outputs/exp-5.2.2.2/feedback-100/teacherlogprobs.json \
    --batch_size 1 \
...
python scripts/hf_logprobs_teacher.py \
    ...
    --student_logprobs_path ./outputs/exp-5.2.2.2/feedback-400/studentlogprobs.json \
    --output_path ./outputs/exp-5.2.2.2/feedback-400/teacherlogprobs.json \
    --batch_size 1 \
...
python scripts/hf_logprobs_teacher.py \
    ...
    --student_logprobs_path ./outputs/exp-5.2.2.2/feedback-1600/studentlogprobs.json \
    --output_path ./outputs/exp-5.2.2.2/feedback-1600/teacherlogprobs.json \
    --batch_size 1 \